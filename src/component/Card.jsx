...
function Card({data}) {
    return(
        ...
        <div className="group max-w-[280px] shadow-md overflow-hidden rounded-md h-full">
            <figure className="h-[110px] lg:h-[160px] w-full overflow-hidden relative bg-slate-50">
                <img className="group-hover:scale-110 transition ease-in-out delay-150 duration-300 object-cover h-full w-full" data-splide-lazy={data.image ? data.image : '/src/img/NoImageFound.png'} alt={data.title}/>
